...
demo output does not drift between runs.
"""
...
Read all records together before tagging any of them. Several tickets share a root cause that is only visible across records.
...
Account context (tiers are stated in the notes; GMV figures are not given):
- Meridian Foods: top-5 account by GMV
- Palisade Resorts Group: enterprise tier, high visibility
- Northwind Distributors: mid-market, high complaint volume relative to size
- Cobalt Hospitality: mid-size, growing fast, churn-risk signal flagged by CS
- Oakmere Culinary Supply: small regional, low GMV
- "Internal": proactive proposals from the product team
...
TOOL_SCHEMA = {
    ...
    "input_schema": {
        "type": "object",
        "required": ["clusters", "tickets", "cross_record_observations"],
        "properties": {
            "clusters": {
                "type": "array",
                "items": {
