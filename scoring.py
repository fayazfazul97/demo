...
DEFAULT_CONFIG: dict[str, Any] = {
    # Relative weight of an account. GMV is not in the dataset, only tier
    # language in the notes, so these are an assumption and are stated as one.
    "account_weight": {
        "Meridian Foods": 5,            # "top-5 account by GMV"
        "Palisade Resorts Group": 5,    # "enterprise tier, high visibility"
        "Northwind Distributors": 3,    # "mid-market"
        "Cobalt Hospitality": 3,        # "mid-size but growing fast"
        "Oakmere Culinary Supply": 1,   # "small regional account, low GMV"
        "Internal": 3,                  # proactive proposals, base weight
    },
